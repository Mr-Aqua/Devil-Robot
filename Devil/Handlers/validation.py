...
from Devil import INSPECTOR, ENFORCER, DEV_USERS, DEL_CMDS, SUPPORT_CHAT, dispatcher
...
def is_whitelist_plus(chat: Chat, user_id: int, member: ChatMember = None) -> bool:
    return any(user_id in user for user in [ ENFORCER, INSPECTOR, DEV_USERS])


def is_support_plus(chat: Chat, user_id: int, member: ChatMember = None) -> bool:
    return user_id in ENFORCER or user_id in INSPECTOR or user_id in DEV_USERS
...
from Devil.Modules.Plugins import connection
