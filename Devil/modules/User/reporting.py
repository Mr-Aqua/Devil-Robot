...
from Devil.Functions.validation import user_admin, user_not_admin, is_user_admin
...
REPORT_GROUP = 12
REPORT_IMMUNE_USERS = INSPECTOR.union(ENFORCER)
    ...
    if chat.type == chat.PRIVATE:
        if len(args) >= 1:
            if args[0] in ("yes", "on"):
                ...
                msg.reply_text(
                    "Turned on reporting! You'll be notified whenever anDevil reports something."
                )
