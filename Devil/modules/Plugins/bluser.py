...
import html
import Devil.Database.blacklistusers_sql as sql
from Devil import (
    DEV_USERS,
    OWNER_ID,
    INSPECTOR,
...
from Devil.Modules.Plugins.log_channel import gloggable
from telegram import ParseMode, Update
from telegram.error import BadRequest
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

BLACKLISTWHITELIST = DEV_USERS.union(INSPECTOR).union(ENFORCER).add(OWNER_ID)
